...
from mysecuri.settings.base import *
...
DATABASES = {
    'default': {
        ...
        'NAME': '/srv/www/ccgate/mysecuri/mysecuri/db/mysec.db',                       # Or path to database file if using sqlite3.
...
ROOT_URLCONF = 'mysecuri.urls.dev'
